    ...
    <>
      <div className="home-container">
        <div className="navabar">
          ...
          <div>
            <h2 style={{color:'whitesmoke',display:'inline-block'}}></h2>
          </div>
          <div>
        ...
        {selectedProduct && (
          <div className="selected-product">
            ...
            <img src={selectedProduct.thumbnail} alt="Selected Product" />
        ...
        <div className="product-container">
          {currentItems.map((val, ind) => {
            return (
              <div key={ind} id={val.id} className="card" onClick={() => handleProductClick(val)}>
                <img src={val.thumbnail} alt="Denim Jeans" style={{ width: "100%" }}/>
                <h1>{val.title}</h1>
...
//                   <p className="price">stock: {val.stock}</p>
//                   <p>{val.description}</p>
//                   <p><button onClick={() => handleAddToCart(val)}>See More</button> </p>
//                 </div>
//               </div>
//             );
//           })}
